...
colnames("mu","mu_hat","p_value","null_hypothesis")
```
...
```{r}
mean <- aggregate(mu_hat ~ mu, data = t_test_result, mean)
mean <- aggregate(mu_hat ~ mu, data = t_test_results[t_test_result$null_hypothesis == TRUE, ], mean)
